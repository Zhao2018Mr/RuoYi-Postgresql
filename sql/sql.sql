...
CREATE TABLE "public"."qrtz_fired_triggers" (
  ...
  "is_nonconcurrent" varchar(2) COLLATE "pg_catalog"."default",
  "requests_recovery" varchar(2) COLLATE "pg_catalog"."default"
)
;
...
-- ----------------------------
INSERT INTO "public"."sys_config" VALUES (3, '主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-dark', 'Y', 'admin', '2021-05-26 18:56:31', '', NULL, '深色主题theme-dark，浅色主题theme-light');
...
-- ----------------------------
INSERT INTO "public"."sys_dict_data" VALUES (4, 1, '显示', '0', 'sys_show_hide', '', 'primary', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '显示菜单');
INSERT INTO "public"."sys_dict_data" VALUES (5, 2, '隐藏', '1', 'sys_show_hide', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '隐藏菜单');
INSERT INTO "public"."sys_dict_data" VALUES (6, 1, '正常', '0', 'sys_normal_disable', '', 'primary', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '正常状态');
INSERT INTO "public"."sys_dict_data" VALUES (7, 2, '停用', '1', 'sys_normal_disable', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '停用状态');
INSERT INTO "public"."sys_dict_data" VALUES (8, 1, '正常', '0', 'sys_job_status', '', 'primary', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '正常状态');
INSERT INTO "public"."sys_dict_data" VALUES (9, 2, '暂停', '1', 'sys_job_status', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '停用状态');
INSERT INTO "public"."sys_dict_data" VALUES (10, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '默认分组');
INSERT INTO "public"."sys_dict_data" VALUES (11, 2, '系统', 'SYSTEM', 'sys_job_group', '', '', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '系统分组');
INSERT INTO "public"."sys_dict_data" VALUES (12, 1, '是', 'Y', 'sys_yes_no', '', 'primary', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '系统默认是');
INSERT INTO "public"."sys_dict_data" VALUES (13, 2, '否', 'N', 'sys_yes_no', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '系统默认否');
INSERT INTO "public"."sys_dict_data" VALUES (14, 1, '通知', '1', 'sys_notice_type', '', 'warning', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '通知');
INSERT INTO "public"."sys_dict_data" VALUES (15, 2, '公告', '2', 'sys_notice_type', '', 'success', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '公告');
INSERT INTO "public"."sys_dict_data" VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '正常状态');
INSERT INTO "public"."sys_dict_data" VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '关闭状态');
INSERT INTO "public"."sys_dict_data" VALUES (18, 1, '新增', '1', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '新增操作');
INSERT INTO "public"."sys_dict_data" VALUES (19, 2, '修改', '2', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '修改操作');
INSERT INTO "public"."sys_dict_data" VALUES (20, 3, '删除', '3', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '删除操作');
INSERT INTO "public"."sys_dict_data" VALUES (21, 4, '授权', '4', 'sys_oper_type', '', 'primary', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '授权操作');
INSERT INTO "public"."sys_dict_data" VALUES (22, 5, '导出', '5', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '导出操作');
INSERT INTO "public"."sys_dict_data" VALUES (23, 6, '导入', '6', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '导入操作');
INSERT INTO "public"."sys_dict_data" VALUES (24, 7, '强退', '7', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '强退操作');
INSERT INTO "public"."sys_dict_data" VALUES (25, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '生成操作');
INSERT INTO "public"."sys_dict_data" VALUES (26, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '清空操作');
INSERT INTO "public"."sys_dict_data" VALUES (27, 1, '成功', '0', 'sys_common_status', '', 'primary', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '正常状态');
INSERT INTO "public"."sys_dict_data" VALUES (28, 2, '失败', '1', 'sys_common_status', '', 'danger', 'N', '0', 'admin', '2021-05-26 18:56:31', '', NULL, '停用状态');
INSERT INTO "public"."sys_dict_data" VALUES (2, 2, '女', '1', 'sys_user_sex', '', '', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '性别女');
INSERT INTO "public"."sys_dict_data" VALUES (3, 3, '未知', '2', 'sys_user_sex', '', '', 'N', '0', 'admin', '2021-05-26 18:56:30', '', NULL, '性别未知');
INSERT INTO "public"."sys_dict_data" VALUES (1, 1, '男', '0', 'sys_user_sex', '', '', 'Y', '0', 'admin', '2021-05-26 18:56:30', 'admin', '2021-05-27 09:07:36.76234', '性别男');
...
-- ----------------------------
INSERT INTO "public"."sys_logininfor" VALUES (1, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2021-05-26 19:59:01.558374');
INSERT INTO "public"."sys_logininfor" VALUES (2, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2021-05-26 20:00:12.336516');
INSERT INTO "public"."sys_logininfor" VALUES (3, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2021-05-27 08:44:45.699806');
INSERT INTO "public"."sys_logininfor" VALUES (4, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2021-05-27 09:15:47.25556');
INSERT INTO "public"."sys_logininfor" VALUES (5, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2021-05-27 09:15:51.653966');
INSERT INTO "public"."sys_logininfor" VALUES (6, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-05-27 09:16:34.905964');
INSERT INTO "public"."sys_logininfor" VALUES (7, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2021-05-27 10:19:05.548252');
INSERT INTO "public"."sys_logininfor" VALUES (8, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2021-05-27 10:21:19.701847');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO "public"."sys_menu" VALUES (1, '系统管理', 0, 1, 'system', NULL, 1, 0, 'M', '0', 0, '', 'system', 'admin', '2021-05-26 18:56:28', '', NULL, '系统管理目录');
INSERT INTO "public"."sys_menu" VALUES (3, '系统工具', 0, 3, 'tool', NULL, 1, 0, 'M', '0', 0, '', 'tool', 'admin', '2021-05-26 18:56:28', '', NULL, '系统工具目录');
INSERT INTO "public"."sys_menu" VALUES (4, '若依官网', 0, 4, 'http://ruoyi.vip', NULL, 0, 0, 'M', '0', 0, '', 'guide', 'admin', '2021-05-26 18:56:28', '', NULL, '若依官网地址');
INSERT INTO "public"."sys_menu" VALUES (100, '用户管理', 1, 1, 'user', 'system/user/index', 1, 0, 'C', '0', 0, 'system:user:list', 'user', 'admin', '2021-05-26 18:56:28', '', NULL, '用户管理菜单');
INSERT INTO "public"."sys_menu" VALUES (101, '角色管理', 1, 2, 'role', 'system/role/index', 1, 0, 'C', '0', 0, 'system:role:list', 'peoples', 'admin', '2021-05-26 18:56:28', '', NULL, '角色管理菜单');
INSERT INTO "public"."sys_menu" VALUES (102, '菜单管理', 1, 3, 'menu', 'system/menu/index', 1, 0, 'C', '0', 0, 'system:menu:list', 'tree-table', 'admin', '2021-05-26 18:56:28', '', NULL, '菜单管理菜单');
INSERT INTO "public"."sys_menu" VALUES (103, '部门管理', 1, 4, 'dept', 'system/dept/index', 1, 0, 'C', '0', 0, 'system:dept:list', 'tree', 'admin', '2021-05-26 18:56:28', '', NULL, '部门管理菜单');
INSERT INTO "public"."sys_menu" VALUES (104, '岗位管理', 1, 5, 'post', 'system/post/index', 1, 0, 'C', '0', 0, 'system:post:list', 'post', 'admin', '2021-05-26 18:56:28', '', NULL, '岗位管理菜单');
INSERT INTO "public"."sys_menu" VALUES (105, '字典管理', 1, 6, 'dict', 'system/dict/index', 1, 0, 'C', '0', 0, 'system:dict:list', 'dict', 'admin', '2021-05-26 18:56:28', '', NULL, '字典管理菜单');
INSERT INTO "public"."sys_menu" VALUES (106, '参数设置', 1, 7, 'config', 'system/config/index', 1, 0, 'C', '0', 0, 'system:config:list', 'edit', 'admin', '2021-05-26 18:56:28', '', NULL, '参数设置菜单');
INSERT INTO "public"."sys_menu" VALUES (107, '通知公告', 1, 8, 'notice', 'system/notice/index', 1, 0, 'C', '0', 0, 'system:notice:list', 'message', 'admin', '2021-05-26 18:56:28', '', NULL, '通知公告菜单');
INSERT INTO "public"."sys_menu" VALUES (108, '日志管理', 1, 9, 'log', '', 1, 0, 'M', '0', 0, '', 'log', 'admin', '2021-05-26 18:56:28', '', NULL, '日志管理菜单');
INSERT INTO "public"."sys_menu" VALUES (109, '在线用户', 2, 1, 'online', 'monitor/online/index', 1, 0, 'C', '0', 0, 'monitor:online:list', 'online', 'admin', '2021-05-26 18:56:28', '', NULL, '在线用户菜单');
INSERT INTO "public"."sys_menu" VALUES (110, '定时任务', 2, 2, 'job', 'monitor/job/index', 1, 0, 'C', '0', 0, 'monitor:job:list', 'job', 'admin', '2021-05-26 18:56:28', '', NULL, '定时任务菜单');
INSERT INTO "public"."sys_menu" VALUES (111, '数据监控', 2, 3, 'druid', 'monitor/druid/index', 1, 0, 'C', '0', 0, 'monitor:druid:list', 'druid', 'admin', '2021-05-26 18:56:28', '', NULL, '数据监控菜单');
INSERT INTO "public"."sys_menu" VALUES (112, '服务监控', 2, 4, 'server', 'monitor/server/index', 1, 0, 'C', '0', 0, 'monitor:server:list', 'server', 'admin', '2021-05-26 18:56:28', '', NULL, '服务监控菜单');
INSERT INTO "public"."sys_menu" VALUES (113, '缓存监控', 2, 5, 'cache', 'monitor/cache/index', 1, 0, 'C', '0', 0, 'monitor:cache:list', 'redis', 'admin', '2021-05-26 18:56:28', '', NULL, '缓存监控菜单');
INSERT INTO "public"."sys_menu" VALUES (114, '表单构建', 3, 1, 'build', 'tool/build/index', 1, 0, 'C', '0', 0, 'tool:build:list', 'build', 'admin', '2021-05-26 18:56:28', '', NULL, '表单构建菜单');
INSERT INTO "public"."sys_menu" VALUES (115, '代码生成', 3, 2, 'gen', 'tool/gen/index', 1, 0, 'C', '0', 0, 'tool:gen:list', 'code', 'admin', '2021-05-26 18:56:28', '', NULL, '代码生成菜单');
INSERT INTO "public"."sys_menu" VALUES (116, '系统接口', 3, 3, 'swagger', 'tool/swagger/index', 1, 0, 'C', '0', 0, 'tool:swagger:list', 'swagger', 'admin', '2021-05-26 18:56:28', '', NULL, '系统接口菜单');
INSERT INTO "public"."sys_menu" VALUES (500, '操作日志', 108, 1, 'operlog', 'monitor/operlog/index', 1, 0, 'C', '0', 0, 'monitor:operlog:list', 'form', 'admin', '2021-05-26 18:56:28', '', NULL, '操作日志菜单');
INSERT INTO "public"."sys_menu" VALUES (501, '登录日志', 108, 2, 'logininfor', 'monitor/logininfor/index', 1, 0, 'C', '0', 0, 'monitor:logininfor:list', 'logininfor', 'admin', '2021-05-26 18:56:28', '', NULL, '登录日志菜单');
INSERT INTO "public"."sys_menu" VALUES (1001, '用户查询', 100, 1, '', '', 1, 0, 'F', '0', 0, 'system:user:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1002, '用户新增', 100, 2, '', '', 1, 0, 'F', '0', 0, 'system:user:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1003, '用户修改', 100, 3, '', '', 1, 0, 'F', '0', 0, 'system:user:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1004, '用户删除', 100, 4, '', '', 1, 0, 'F', '0', 0, 'system:user:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1005, '用户导出', 100, 5, '', '', 1, 0, 'F', '0', 0, 'system:user:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1006, '用户导入', 100, 6, '', '', 1, 0, 'F', '0', 0, 'system:user:import', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1007, '重置密码', 100, 7, '', '', 1, 0, 'F', '0', 0, 'system:user:resetPwd', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1008, '角色查询', 101, 1, '', '', 1, 0, 'F', '0', 0, 'system:role:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1009, '角色新增', 101, 2, '', '', 1, 0, 'F', '0', 0, 'system:role:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1010, '角色修改', 101, 3, '', '', 1, 0, 'F', '0', 0, 'system:role:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1011, '角色删除', 101, 4, '', '', 1, 0, 'F', '0', 0, 'system:role:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1012, '角色导出', 101, 5, '', '', 1, 0, 'F', '0', 0, 'system:role:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1013, '菜单查询', 102, 1, '', '', 1, 0, 'F', '0', 0, 'system:menu:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1014, '菜单新增', 102, 2, '', '', 1, 0, 'F', '0', 0, 'system:menu:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1015, '菜单修改', 102, 3, '', '', 1, 0, 'F', '0', 0, 'system:menu:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1016, '菜单删除', 102, 4, '', '', 1, 0, 'F', '0', 0, 'system:menu:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1017, '部门查询', 103, 1, '', '', 1, 0, 'F', '0', 0, 'system:dept:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1018, '部门新增', 103, 2, '', '', 1, 0, 'F', '0', 0, 'system:dept:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1019, '部门修改', 103, 3, '', '', 1, 0, 'F', '0', 0, 'system:dept:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1020, '部门删除', 103, 4, '', '', 1, 0, 'F', '0', 0, 'system:dept:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1021, '岗位查询', 104, 1, '', '', 1, 0, 'F', '0', 0, 'system:post:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1022, '岗位新增', 104, 2, '', '', 1, 0, 'F', '0', 0, 'system:post:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1023, '岗位修改', 104, 3, '', '', 1, 0, 'F', '0', 0, 'system:post:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1024, '岗位删除', 104, 4, '', '', 1, 0, 'F', '0', 0, 'system:post:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1025, '岗位导出', 104, 5, '', '', 1, 0, 'F', '0', 0, 'system:post:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1026, '字典查询', 105, 1, '#', '', 1, 0, 'F', '0', 0, 'system:dict:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1027, '字典新增', 105, 2, '#', '', 1, 0, 'F', '0', 0, 'system:dict:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1028, '字典修改', 105, 3, '#', '', 1, 0, 'F', '0', 0, 'system:dict:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1029, '字典删除', 105, 4, '#', '', 1, 0, 'F', '0', 0, 'system:dict:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1030, '字典导出', 105, 5, '#', '', 1, 0, 'F', '0', 0, 'system:dict:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1031, '参数查询', 106, 1, '#', '', 1, 0, 'F', '0', 0, 'system:config:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1032, '参数新增', 106, 2, '#', '', 1, 0, 'F', '0', 0, 'system:config:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1033, '参数修改', 106, 3, '#', '', 1, 0, 'F', '0', 0, 'system:config:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1034, '参数删除', 106, 4, '#', '', 1, 0, 'F', '0', 0, 'system:config:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1035, '参数导出', 106, 5, '#', '', 1, 0, 'F', '0', 0, 'system:config:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1036, '公告查询', 107, 1, '#', '', 1, 0, 'F', '0', 0, 'system:notice:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1037, '公告新增', 107, 2, '#', '', 1, 0, 'F', '0', 0, 'system:notice:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1038, '公告修改', 107, 3, '#', '', 1, 0, 'F', '0', 0, 'system:notice:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1039, '公告删除', 107, 4, '#', '', 1, 0, 'F', '0', 0, 'system:notice:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1040, '操作查询', 500, 1, '#', '', 1, 0, 'F', '0', 0, 'monitor:operlog:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1041, '操作删除', 500, 2, '#', '', 1, 0, 'F', '0', 0, 'monitor:operlog:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1042, '日志导出', 500, 4, '#', '', 1, 0, 'F', '0', 0, 'monitor:operlog:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1043, '登录查询', 501, 1, '#', '', 1, 0, 'F', '0', 0, 'monitor:logininfor:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1044, '登录删除', 501, 2, '#', '', 1, 0, 'F', '0', 0, 'monitor:logininfor:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1045, '日志导出', 501, 3, '#', '', 1, 0, 'F', '0', 0, 'monitor:logininfor:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1046, '在线查询', 109, 1, '#', '', 1, 0, 'F', '0', 0, 'monitor:online:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1047, '批量强退', 109, 2, '#', '', 1, 0, 'F', '0', 0, 'monitor:online:batchLogout', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1048, '单条强退', 109, 3, '#', '', 1, 0, 'F', '0', 0, 'monitor:online:forceLogout', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1049, '任务查询', 110, 1, '#', '', 1, 0, 'F', '0', 0, 'monitor:job:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1050, '任务新增', 110, 2, '#', '', 1, 0, 'F', '0', 0, 'monitor:job:add', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1051, '任务修改', 110, 3, '#', '', 1, 0, 'F', '0', 0, 'monitor:job:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1052, '任务删除', 110, 4, '#', '', 1, 0, 'F', '0', 0, 'monitor:job:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1053, '状态修改', 110, 5, '#', '', 1, 0, 'F', '0', 0, 'monitor:job:changeStatus', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1054, '任务导出', 110, 7, '#', '', 1, 0, 'F', '0', 0, 'monitor:job:export', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1055, '生成查询', 115, 1, '#', '', 1, 0, 'F', '0', 0, 'tool:gen:query', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1056, '生成修改', 115, 2, '#', '', 1, 0, 'F', '0', 0, 'tool:gen:edit', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1057, '生成删除', 115, 3, '#', '', 1, 0, 'F', '0', 0, 'tool:gen:remove', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1058, '导入代码', 115, 2, '#', '', 1, 0, 'F', '0', 0, 'tool:gen:import', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1059, '预览代码', 115, 4, '#', '', 1, 0, 'F', '0', 0, 'tool:gen:preview', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (1060, '生成代码', 115, 5, '#', '', 1, 0, 'F', '0', 0, 'tool:gen:code', '#', 'admin', '2021-05-26 18:56:28', '', NULL, '');
INSERT INTO "public"."sys_menu" VALUES (2, '系统监控', 0, 2, 'monitor', NULL, 1, 0, 'M', '0', 0, '', 'monitor', 'admin', '2021-05-26 18:56:28', 'admin', '2021-05-27 09:50:57.653895', '系统监控目录');
